...
public interface PurchaseOrderRepository extends JpaRepository<PurchaseOrder, Integer> {
	...
	@Query("SELECT FUNCTION('DATE_FORMAT', o.orderDate, '%Y-%m') AS month, SUM(d.unitPrice * d.quantity) "
			+ "FROM PurchaseOrder o JOIN o.details d " + "GROUP BY month ORDER BY month")
	...
	@Query("""
			...
			WHERE o.supplier.name LIKE :keyword
			""")
	List<PurchaseOrder> findBySupplierName(@Param("keyword") String keyword);
}
